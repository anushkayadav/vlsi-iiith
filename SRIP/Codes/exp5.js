...
function init(){
    ...
    $('.connect').on('mousedown',function(e){
        ...
        cur_con.attr('x1', start.left + cur_ui_item.width()-5).attr('y1', start.top+(0.50 * cur_ui_item.height())).attr('x2',start.left+cur_ui_item.width()).attr('y2',start.top+(0.48 * cur_ui_item.height()));
    });
